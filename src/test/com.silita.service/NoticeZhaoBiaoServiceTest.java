...
//        String requestBody = "{\"source\":\"hunan\", \"proviceCode\":\"hunan\", \"cityCode\":\"changsha\", \"ntStatus\":\"\", \"ntCategory\":\"1\", \"title\":\"测试\", \"pubDate\":\"2018-08-10\", \"pubEndDate\":\"2018-08-20\", \"currentPage\":\"1\", \"pageSize\":\"5\"}";
    ...
    public void testController10()throws Exception{
        String requestBody = "{\"ntId\":\"11\", \"source\":\"hunan\"}";
    ...
    public void testController33()throws Exception{
        String requestBody = "{\"ntId\":\"20\", \"source\":\"hunan\", \"pkid\":\"3c2de083a179462c9eaae2df41395b05\"}";
    ...
    public void testController20()throws Exception{
        String requestBody = "{\"idsStr\":\"10|11\", \"source\":\"hunan\"}";
...
//        String requestBody = "{\"tbNtRegexGroups\":[{\"tbNtQuaGroups\":[{\"quaId\":\"老板a2\",\"relType\":\"|\"}],\"quaId\":\"老板a1\",\"relType\":\"&\"},{\"tbNtQuaGroups\":[],\"quaId\":\"老板b1\"}],\"params\":{\"ntId\":\"3\",\"ntEditId\":\"3\",\"userName\":\"gmy\"}}";
        String requestBody = "{\"tbNtRegexGroups\":[{\"tbNtQuaGroups\":[{\"relType\":\"&\",\"qualIds\":[\"zhinanA2\",\"shejiyuanzeA2\",\"fankuiA2\"]},{\"relType\":\"&\",\"qualIds\":[\"zhinanA3\",\"shejiyuanzeA3\",\"fankuiA3\"]}],\"qualIds\":[\"zhinanA1\",\"shejiyuanzeA1\",\"yizhiA1\"],\"relType\":\"&\"},{\"tbNtQuaGroups\":[{\"relType\":\"&\",\"qualIds\":[\"zhinanB2\",\"shejiyuanzeB2\",\"fankuiB2\"]}],\"qualIds\":[\"zhinanB1\",\"shejiyuanzeB1\",\"yizhiB1\"],\"relType\":\"|\"},{\"tbNtQuaGroups\":[],\"qualIds\":[\"zhinanC1\",\"shejiyuanzeC1\",\"yizhiC1\"],\"relType\":\"\"}],\"params\":{\"ntId\":\"3\",\"ntEditId\":\"3\",\"userName\":\"gmy\"}}";
